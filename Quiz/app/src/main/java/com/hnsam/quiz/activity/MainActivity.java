...
import com.hnsam.quiz.helper.BookmarkDBHelper;
import com.hnsam.quiz.helper.DBHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public View devider;
    public RelativeLayout lytLeaderBoard, lytProfile, lytSignOut, lytBattle, lytPlay, lytSetting, bottomLyt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!type.equals("null")) {
            if (type.equals("category")) {
                ...
                Constant.CATE_ID = 1;//Integer.valueOf(getIntent().getStringExtra("cateId"));
